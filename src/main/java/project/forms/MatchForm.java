...
public class MatchForm {
    ...
    public MatchForm(  String teamOneLogo, String teamOneName, double teamOneK, String teamTwoLogo, String teamTwoName, double teamTwoK, String date, String time, double drawK) {
